...
AI essay grading and feedback for writing assessment

> Provides detailed feedback on essays, rubric-based grading, and suggestions for improvement

## What It Does

- Grade essays with detailed rubric-based assessment
- Generate constructive feedback for student improvement
- Support multiple essay types and subject areas
- Maintain academic integrity with local, explainable AI
